<ul class="nav nav-pills mb-3 d-flex justify-content-center" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="top-btn active" onclick="clearQR()" id="pills-text-tab" data-bs-toggle="pill"
    ...
    <li class="nav-item" role="presentation">
        <button class="top-btn" id="pills-url-tab"  onclick="clearQR()" data-bs-toggle="pill" data-bs-target="#pills-url"
                type="button" role="tab" aria-controls="pills-url" aria-selected="false"><i class="fa fa-link"
                                                                                            aria-hidden="true"></i> URL</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="top-btn" id="pills-phone-tab" onclick="clearQR()" data-bs-toggle="pill" data-bs-target="#pills-phone"
    ...
    <li class="nav-item" role="presentation">
        <button class="top-btn" id="pills-sms-tab" data-bs-toggle="pill" onclick="clearQR()" data-bs-target="#pills-sms"
                type="button" role="tab" aria-controls="pills-sms" aria-selected="false"><i
                class="fa fa-commenting" aria-hidden="true"></i> SMS</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="top-btn" id="pills-email-tab" data-bs-toggle="pill" onclick="clearQR()" data-bs-target="#pills-email"
    ...
    <li class="nav-item" role="presentation">
        <button class="top-btn" id="pills-location-tab" data-bs-toggle="pill" onclick="clearQR()"
    ...
    <li class="nav-item" role="presentation">
        <button class="top-btn" id="pills-wifi-tab" data-bs-toggle="pill" data-bs-target="#pills-wifi" onclick="clearQR()"
                type="button" role="tab" aria-controls="pills-wifi" aria-selected="false"><i class="fa fa-wifi"
                                                                                             aria-hidden="true"></i> WiFi</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="top-btn" id="pills-vcard-tab" data-bs-toggle="pill" data-bs-target="#pills-vcard" onclick="clearQR()"
