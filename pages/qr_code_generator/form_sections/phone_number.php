<div class="tab-pane fade" id="pills-phone" role="tabpanel" aria-labelledby="pills-phone-tab">
    <form action="" method="post">
        <div class="form-group">
            ...
            <input type="tel" class="form-control" name="phonenumber" pattern="[0-9]" id="phone_number" onchange="makeCodeWithPhone();">
        ...
        <div class="p-3 float-start full collapse" id="collapseExample1Phone1" style="">
            <div class="row">
                <div class="form-group">
     ...
     <div class="row">
        ...
        <button class="btn btn-danger mt-2 full" id="my_file_manager_button_phone_number"  type="button" ><i class="fa-solid fa-image"></i>
            &nbsp; Add a Logo</button>
        ...
        <div class="collapse p-3 float-start full" id="collapseExample1Phone3">
            <h6 class="float-start"> <i class="fa fa-arrows-alt" aria-hidden="true"></i> &nbsp;
                Size</h6>
            <div>
                <input type="number" class="form-control" id="size_phone_number" value="1000" placeholder="Please enter px" onchange="makeCodeWithPhone()">
            </div>
            <br>
