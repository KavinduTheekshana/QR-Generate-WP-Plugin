<div class="tab-pane fade" id="pills-phone" role="tabpanel" aria-labelledby="pills-phone-tab">
    <form action="" method="post">
        ...
        <div class="collapse p-3 float-start full" id="collapseExample1Phone3">
            ...
            <br>
            <h6 class="float-start"> <i class="fa fa-square" id="margin_phone_number" aria-hidden="true"></i> &nbsp;
                Margin Size</h6>
            <div>
                <input type="number" class="form-control" placeholder="Please enter px" onchange="makeCodeWithPhone()">
            </div>
